                  ...
                  [
                    SettingItem(
                      ...
                      child: Switch(
                        ...
                        onChanged: controllers.pageSetting.systemProxySwitchIng.value ? null : controllers.pageSetting.systemProxySwitch,
                      ),
                    ),
                    SettingItem(
                      ...
                      child: Switch(
                        ...
                        onChanged: (v) => controllers.core.fetchConfigUpdate({'allow-lan': v}),
                      ),
                    ),
                  ],
                  [
                    SettingItem(
                      ...
                      child: Switch(
                        ...
                        onChanged: controllers.service.serviceModeSwitching.value ? null : controllers.service.serviceModeSwitch,
                      ),
                    ),
                    const SettingItem(),
                  ],
                ...
                children: [
                  [
                    SettingItem(
                      ...
                      child: ButtonSelect(
                        ...
                        onSelect: (idx) => controllers.core.fetchConfigUpdate({'mode': controllers.pageSetting.modes[idx]}),
                      ),
                    ),
                    SettingItem(
                  ...
                  [
                    SettingItem(
                      ...
                      child: TextButton(onPressed: controllers.pageSetting.launchWebGui, child: Text(controllers.config.clashCoreApiAddress.value)),
                    ),
                    const SettingItem()
                  ],
                ],
