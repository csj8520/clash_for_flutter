...
class CONST {
  static final String clashBinName = Platform.isWindows ? 'clash-windows-amd64.exe' : 'clash-darwin-arm64';
  ...
  // TEMP
  static File configFileJson = File(path.join(configDir.path, '.config.json'));
